pipeline {
    ...
    stages {
        ...
        stage('Deploy Proxy to Environment') {
            ...
            steps {
                stable_revision = "${sh(script: 'curl -H \"Authorization: Basic bXBvbmNlQGFwaXNlcnZpY2UuY2w6TmFydXRvLjIwMjI=\" \"https://api.enterprise.apigee.com/v1/organizations/amer-demo16/apis/petstore-jks/deployments\" | jq -r \".environment[0].revision[0].name\"', returnStdout: true)}"
